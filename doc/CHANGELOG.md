...
* Now there are two level of log that recorded with `log.info()` and `Log.debug()`, about latter invocation, see [this sad class](/common/src/main/java/com/github/khanshoaib3/minecraft_access/utils/Log.java).
